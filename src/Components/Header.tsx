...
const links=["About","Projects","Skills","Certificates","Contact"];
...
const Header=()=> {
  ...
  useEffect(()=>{
    ...
    return (
       <nav className={`flex ${show?"translate-y-0":"-translate-y-28"} ${shadow?"shadow-[0px_10px_30px_-10px_#020c1b]":""} transition-transform duration-500 ease-in-out fixed w-full justify-between h-28 px-10 font-mono bg-bgColor z-10 items-center xs-mx:px-4 xs-mx:h-20`}>
